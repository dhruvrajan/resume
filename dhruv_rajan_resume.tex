...
\section{technical skills}
	...
	Packages: ~~ PyTorch, TensorFlow, nltk3, numpy, pandas, scipy, scikit-learn, OpenCV, Spark
...
\entry
 {2019 (now)}
  {Uber A.T.G.}
  {(Advanced Technologies Group)~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Pittsburgh, PA}
  {\emph{\thinfont Software Engineering Intern (Motion Planning for Self-Driving)}}
...
\entry
  {2019-now}
  {Tensorflow Keras for Java}
  {\href{https://github.com/dhruvrajan/tensorflow-keras-java}{github.com/dhruvrajan/tensorflow-keras-java} ~~~~Los Altos, CA}
  {Developing a high level training API on TensorFlow Java, based on {\href{https://www.tensorflow.org/api_docs/python/tf/keras}{tf.keras}}}
...
\entry
  ...
  {Structural ``note-taking" service to increase meeting productivity using NLP.}
